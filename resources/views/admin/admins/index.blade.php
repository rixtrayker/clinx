      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header border-bottom">
            ...
            <a class=" text-lg btn-lg btn-primary btn-round waves-effect waves-float waves-light" href="{{route('admins.create')}}"> <i data-feather='plus' class="text-3xl mr-1"></i> @lang('admin.Create')</a>
          </div>
                        ...
                        <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{route('admins.edit', $record->id)}}"><i class="fa fa-edit"></i> @lang('admin.Edit')</a>
                                        ...
                                        <form role="form" action="{{ route('admins.destroy',$record->id) }}" class="" method="POST">
