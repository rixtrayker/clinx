  ...
  <ul id="side-nav" class="main-menu navbar-collapse collapse">
    ...
    {{-- @if(App\Libs\Adminauth::user()->id == 2) --}}
      ...
      {{-- @endif --}}
      <li class="{{(Request::is('admin/roles/') || Request::is(App::getLocale().'/admin/patients/create'))?"active":""}}"><a href="{{url(App::getLocale()."/admin/patients/create")}}"><i class=" icon-plus-squared"></i><span class="title">انشاء طفل جديد</span></a></li>
      ...
      @endif --}}
    {{-- @endif --}}
    <li class="{{(Request::is('admin/roles') )?"active":""}}"><a href="{{url("/admin/roles/")}}"><i class="icon-archive"></i><span class="title">@lang('admin.Roles')</span></a></li>
